...
SECTORS = {
    'fintech': {
        'keywords': [
            'fintech', 'payment', 'banking', 'bank', 'finance', 'financial',
            'insurance', 'insurtech', 'lending', 'credit', 'loan', 'invest',
            'trading', 'crypto', 'blockchain', 'wallet', 'neobank', 'regtech',
            'wealthtech', 'paytech', 'money', 'capital', 'fund', 'asset',
        ],
    ...
    'saas': {
        'keywords': [
            'saas', 'software', 'platform', 'cloud', 'automation', 'workflow',
            'productivity', 'collaboration', 'enterprise', 'b2b', 'crm', 'erp',
            'analytics', 'dashboard', 'api', 'integration', 'tool', 'solution',
        ],
    ...
    'ecommerce': {
        'keywords': [
            ...
            'commerce', 'shopping', 'd2c', 'direct to consumer', 'brand',
            'fashion', 'apparel', 'beauty', 'consumer', 'cpg',
        ],
    ...
    'healthtech': {
        'keywords': [
            'health', 'healthcare', 'medical', 'medicine', 'pharma', 'biotech',
            'digital health', 'telehealth', 'telemedicine', 'wellness', 'fitness',
            'mental health', 'therapy', 'clinic', 'hospital', 'patient', 'doctor',
            'diagnostics', 'drug', 'clinical', 'life science',
        ],
    ...
    'proptech': {
        'keywords': [
            'proptech', 'real estate', 'property', 'housing', 'home', 'rent',
            'rental', 'immobilien', 'wohnung', 'building', 'construction',
            'architecture', 'facility', 'smart home', 'iot home',
        ],
    ...
    'mobility': {
        'keywords': [
            'mobility', 'transport', 'transportation', 'automotive', 'car',
            'vehicle', 'ev', 'electric vehicle', 'scooter', 'bike', 'bicycle',
            'ride', 'sharing', 'fleet', 'logistics', 'delivery', 'last mile',
            'shipping', 'freight', 'trucking', 'aviation', 'drone',
        ],
    ...
    'foodtech': {
        'keywords': [
            'food', 'foodtech', 'delivery', 'restaurant', 'meal', 'grocery',
            'kitchen', 'cooking', 'recipe', 'nutrition', 'diet', 'agtech',
            'agriculture', 'farming', 'sustainable food', 'plant-based',
            'alternative protein', 'vertical farming',
        ],
    ...
    'edtech': {
        'keywords': [
            'education', 'edtech', 'learning', 'training', 'course', 'school',
            'university', 'student', 'teacher', 'tutor', 'skill', 'upskill',
            'reskill', 'bootcamp', 'certification', 'e-learning', 'mooc',
        ],
    ...
    'hrtech': {
        'keywords': [
            'hr', 'human resources', 'hiring', 'recruiting', 'recruitment',
            'talent', 'workforce', 'employee', 'payroll', 'benefits', 'culture',
            'engagement', 'performance', 'onboarding', 'staffing', 'job',
        ],
    ...
    'ai_ml': {
        'keywords': [
            ...
            'neural', 'nlp', 'natural language', 'computer vision', 'robotics',
            'automation', 'intelligent', 'predictive', 'generative', 'llm',
            'gpt', 'chatbot', 'voice', 'speech',
        ],
    ...
    'cybersecurity': {
        'keywords': [
            'security', 'cybersecurity', 'cyber', 'infosec', 'privacy',
            'encryption', 'identity', 'authentication', 'fraud', 'compliance',
            'risk', 'threat', 'vulnerability', 'penetration', 'soc', 'siem',
        ],
    ...
    'cleantech': {
        'keywords': [
            'clean', 'cleantech', 'climate', 'sustainability', 'sustainable',
            'green', 'renewable', 'energy', 'solar', 'wind', 'battery',
            'carbon', 'emission', 'environment', 'recycling', 'circular',
            'waste', 'water', 'hydrogen', 'ev charging',
        ],
    ...
    'gaming': {
        'keywords': [
            'gaming', 'game', 'esports', 'metaverse', 'virtual reality', 'vr',
            'augmented reality', 'ar', 'entertainment', 'streaming', 'content',
            'creator', 'media', 'video', 'music', 'podcast',
        ],
    ...
    'legaltech': {
        'keywords': [
            'legal', 'legaltech', 'law', 'lawyer', 'contract', 'compliance',
            'regulatory', 'notary', 'dispute', 'litigation', 'ip', 'patent',
        ],
    ...
    'marketingtech': {
        'keywords': [
            'marketing', 'martech', 'advertising', 'adtech', 'seo', 'sem',
            'social media', 'influencer', 'content marketing', 'email',
            'crm', 'customer', 'engagement', 'loyalty', 'personalization',
        ],
    ...
    'devtools': {
        'keywords': [
            'developer', 'devtools', 'infrastructure', 'devops', 'ci/cd',
            'monitoring', 'observability', 'testing', 'code', 'git', 'api',
            'database', 'serverless', 'container', 'kubernetes', 'open source',
        ],
...
B2B_KEYWORDS = [
    'enterprise', 'b2b', 'business', 'corporate', 'saas', 'platform',
    'solution', 'service provider', 'consultant', 'agency',
]

B2C_KEYWORDS = [
    'consumer', 'b2c', 'app', 'personal', 'individual', 'user',
    'customer', 'retail', 'shop', 'marketplace',
]

# Stage indicators from company names/descriptions
EARLY_STAGE_INDICATORS = [
    'stealth', 'beta', 'alpha', 'launching', 'pre-launch', 'coming soon',
    'mvp', 'prototype', 'early stage', 'seed', 'pre-seed',
]
...
if __name__ == '__main__':
    import sys
    sys.path.insert(0, '/home/user/handelsregister-scraper')
